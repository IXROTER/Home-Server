...
# List of file URLs
file_urls = [
    "https://zlxabg-server.000webhostapp.com/init.vim",
    "https://zlxabg-server.000webhostapp.com/basic-cpp.py",
    "https://zlxabg-server.000webhostapp.com/random-code-generator.py"
    ]
